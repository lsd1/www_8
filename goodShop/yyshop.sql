...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`yyshop` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `yyshop`;

/*Table structure for table `yyshop_activity` */

DROP TABLE IF EXISTS `yyshop_activity`;

CREATE TABLE `yyshop_activity` (
...
/*Data for the table `yyshop_activity` */

/*Table structure for table `yyshop_activity_detail` */

DROP TABLE IF EXISTS `yyshop_activity_detail`;

CREATE TABLE `yyshop_activity_detail` (
...
/*Data for the table `yyshop_activity_detail` */

/*Table structure for table `yyshop_address` */

DROP TABLE IF EXISTS `yyshop_address`;

CREATE TABLE `yyshop_address` (
...
/*Data for the table `yyshop_address` */

/*Table structure for table `yyshop_admin` */

DROP TABLE IF EXISTS `yyshop_admin`;

CREATE TABLE `yyshop_admin` (
...
/*Data for the table `yyshop_admin` */

insert  into `yyshop_admin`(`admin_id`,`admin_name`,`admin_avatar`,`admin_password`,`admin_login_time`,`admin_login_num`,`admin_is_super`,`admin_gid`,`admin_quick_link`) values (1,'admin',NULL,'670b14728ad9902aecba32e22fa4f6bd',1546071576,2,1,0,NULL);

/*Table structure for table `yyshop_admin_log` */

DROP TABLE IF EXISTS `yyshop_admin_log`;

CREATE TABLE `yyshop_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';

/*Data for the table `yyshop_admin_log` */

insert  into `yyshop_admin_log`(`id`,`content`,`createtime`,`admin_name`,`admin_id`,`ip`,`url`) values (1,'登录',1546071561,'admin',1,'127.0.0.1','login&login'),(2,'清理缓存',1546071564,'admin',1,'127.0.0.1','cache&'),(3,'登录',1546071576,'admin',1,'127.0.0.1','login&login');

/*Table structure for table `yyshop_adv` */

DROP TABLE IF EXISTS `yyshop_adv`;

CREATE TABLE `yyshop_adv` (
...
/*Data for the table `yyshop_adv` */

insert  into `yyshop_adv`(`adv_id`,`ap_id`,`adv_title`,`adv_content`,`adv_start_date`,`adv_end_date`,`slide_sort`,`member_id`,`member_name`,`click_num`,`is_allow`,`buy_style`,`goldpay`) values (15,9,'首页通栏','a:2:{s:7:\"adv_pic\";s:21:\"04716538681718544.png\";s:11:\"adv_pic_url\";s:13:\"www.33hao.com\";}',1388505600,1577721600,0,0,'',0,1,'',0),(935,11,'好商城活动','a:2:{s:7:\"adv_pic\";s:21:\"05509495194736947.png\";s:11:\"adv_pic_url\";s:20:\"http://www.33hao.com\";}',1434211200,1749312000,0,0,'',0,1,'',0),(936,1047,'好商城V5.5','a:2:{s:7:\"adv_pic\";s:21:\"04891676111561966.png\";s:11:\"adv_pic_url\";s:13:\"www.33hao.com\";}',1435766400,1753891200,0,0,'',0,1,'',0);

/*Table structure for table `yyshop_adv_position` */

DROP TABLE IF EXISTS `yyshop_adv_position`;

CREATE TABLE `yyshop_adv_position` (
...
/*Data for the table `yyshop_adv_position` */

insert  into `yyshop_adv_position`(`ap_id`,`ap_name`,`ap_class`,`ap_display`,`is_use`,`ap_width`,`ap_height`,`adv_num`,`click_num`,`default_content`) values (9,'首页底部通栏图片广告',0,2,1,1200,90,1,0,'04418235791378401.jpg'),(11,'首页中上部banner',0,2,1,1200,90,1,0,'banner.gif'),(35,'积分列表页中部广告位',0,2,1,900,368,0,0,'f448e48ee0deb06707480d46a2a360ae.gif'),(37,'商品列表页左侧广告位',0,1,1,1200,90,0,0,'7a4832d109ee46fe7677c1d3c30e067f.gif'),(1048,'顶部logo边广告',0,2,1,100,70,0,0,'05048168915006375.gif'),(1049,'首页右侧广告1',0,1,1,180,194,0,0,'05193052323128277.jpg'),(1050,'首页右侧广告2',0,1,1,180,194,0,0,'05193052753284411.jpg');

/*Table structure for table `yyshop_album_class` */

DROP TABLE IF EXISTS `yyshop_album_class`;

CREATE TABLE `yyshop_album_class` (
...
/*Data for the table `yyshop_album_class` */

insert  into `yyshop_album_class`(`aclass_id`,`aclass_name`,`store_id`,`aclass_des`,`aclass_sort`,`aclass_cover`,`upload_time`,`is_default`) values (1,'默认相册',1,'',255,'',1387942806,1);

/*Table structure for table `yyshop_album_pic` */

DROP TABLE IF EXISTS `yyshop_album_pic`;

CREATE TABLE `yyshop_album_pic` (
...
/*Data for the table `yyshop_album_pic` */

/*Table structure for table `yyshop_apiseccode` */

DROP TABLE IF EXISTS `yyshop_apiseccode`;

CREATE TABLE `yyshop_apiseccode` (
...
/*Data for the table `yyshop_apiseccode` */

/*Table structure for table `yyshop_area` */

DROP TABLE IF EXISTS `yyshop_area`;

CREATE TABLE `yyshop_area` (
...
/*Data for the table `yyshop_arrival_notice` */

/*Table structure for table `yyshop_article` */

DROP TABLE IF EXISTS `yyshop_article`;

CREATE TABLE `yyshop_article` (
...
/*Data for the table `yyshop_article_class` */

insert  into `yyshop_article_class`(`ac_id`,`ac_code`,`ac_name`,`ac_parent_id`,`ac_sort`) values (1,'notice','商城公告',0,1),(2,'member','新手上路',0,2),(3,'store','商家中心',0,3),(4,'payment','支付方式',0,4),(5,'sold','售后服务',0,5),(6,'service','购物指南',0,6),(7,'about','关于我们',0,7);

/*Table structure for table `yyshop_attribute` */

DROP TABLE IF EXISTS `yyshop_attribute`;

CREATE TABLE `yyshop_attribute` (
...
/*Data for the table `yyshop_attribute` */

/*Table structure for table `yyshop_attribute_value` */

DROP TABLE IF EXISTS `yyshop_attribute_value`;

CREATE TABLE `yyshop_attribute_value` (
...
/*Data for the table `yyshop_attribute_value` */

/*Table structure for table `yyshop_bill_create` */

DROP TABLE IF EXISTS `yyshop_bill_create`;

CREATE TABLE `yyshop_bill_create` (
...
/*Data for the table `yyshop_bill_create` */

/*Table structure for table `yyshop_brand` */

DROP TABLE IF EXISTS `yyshop_brand`;

CREATE TABLE `yyshop_brand` (
...
/*Data for the table `yyshop_cart` */

/*Table structure for table `yyshop_chain` */

DROP TABLE IF EXISTS `yyshop_chain`;

CREATE TABLE `yyshop_chain` (
...
/*Data for the table `yyshop_chain` */

/*Table structure for table `yyshop_chain_stock` */

DROP TABLE IF EXISTS `yyshop_chain_stock`;

CREATE TABLE `yyshop_chain_stock` (
...
/*Data for the table `yyshop_chain_stock` */

/*Table structure for table `yyshop_chat_log` */

DROP TABLE IF EXISTS `yyshop_chat_log`;

CREATE TABLE `yyshop_chat_log` (
...
/*Data for the table `yyshop_chat_log` */

/*Table structure for table `yyshop_chat_msg` */

DROP TABLE IF EXISTS `yyshop_chat_msg`;

CREATE TABLE `yyshop_chat_msg` (
  `m_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `f_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `f_name` varchar(50) NOT NULL COMMENT '会员名',
  `f_ip` varchar(15) NOT NULL COMMENT '发自IP',
...
/*Data for the table `yyshop_chat_msg` */

/*Table structure for table `yyshop_circle` */

DROP TABLE IF EXISTS `yyshop_circle`;

CREATE TABLE `yyshop_circle` (
...
/*Data for the table `yyshop_circle` */

/*Table structure for table `yyshop_circle_affix` */

DROP TABLE IF EXISTS `yyshop_circle_affix`;

CREATE TABLE `yyshop_circle_affix` (
...
/*Data for the table `yyshop_circle_affix` */

/*Table structure for table `yyshop_circle_class` */

DROP TABLE IF EXISTS `yyshop_circle_class`;

CREATE TABLE `yyshop_circle_class` (
...
/*Data for the table `yyshop_circle_class` */

/*Table structure for table `yyshop_circle_explog` */

DROP TABLE IF EXISTS `yyshop_circle_explog`;

CREATE TABLE `yyshop_circle_explog` (
...
/*Data for the table `yyshop_circle_explog` */

/*Table structure for table `yyshop_circle_expmember` */

DROP TABLE IF EXISTS `yyshop_circle_expmember`;

CREATE TABLE `yyshop_circle_expmember` (
...
/*Data for the table `yyshop_circle_expmember` */

/*Table structure for table `yyshop_circle_exptheme` */

DROP TABLE IF EXISTS `yyshop_circle_exptheme`;

CREATE TABLE `yyshop_circle_exptheme` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
/*Data for the table `yyshop_circle_exptheme` */

/*Table structure for table `yyshop_circle_fs` */

DROP TABLE IF EXISTS `yyshop_circle_fs`;

CREATE TABLE `yyshop_circle_fs` (
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
/*Data for the table `yyshop_circle_fs` */

/*Table structure for table `yyshop_circle_inform` */

DROP TABLE IF EXISTS `yyshop_circle_inform`;

CREATE TABLE `yyshop_circle_inform` (
...
/*Data for the table `yyshop_circle_inform` */

/*Table structure for table `yyshop_circle_like` */

DROP TABLE IF EXISTS `yyshop_circle_like`;

CREATE TABLE `yyshop_circle_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主题赞表';

/*Data for the table `yyshop_circle_like` */

/*Table structure for table `yyshop_circle_mapply` */

DROP TABLE IF EXISTS `yyshop_circle_mapply`;

CREATE TABLE `yyshop_circle_mapply` (
...
/*Data for the table `yyshop_circle_mapply` */

/*Table structure for table `yyshop_circle_member` */

DROP TABLE IF EXISTS `yyshop_circle_member`;

CREATE TABLE `yyshop_circle_member` (
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
/*Data for the table `yyshop_circle_member` */

/*Table structure for table `yyshop_circle_ml` */

DROP TABLE IF EXISTS `yyshop_circle_ml`;

CREATE TABLE `yyshop_circle_ml` (
  `circle_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '圈子id',
...
/*Data for the table `yyshop_circle_ml` */

/*Table structure for table `yyshop_circle_mldefault` */

DROP TABLE IF EXISTS `yyshop_circle_mldefault`;

CREATE TABLE `yyshop_circle_mldefault` (
...
/*Data for the table `yyshop_circle_mldefault` */

insert  into `yyshop_circle_mldefault`(`mld_id`,`mld_name`,`mld_exp`) values (1,'初级粉丝',1),(2,'中级粉丝',5),(3,'高级粉丝',15),(4,'正式会员',30),(5,'正式会员',50),(6,'核心会员',100),(7,'核心会员',200),(8,'铁杆会员',500),(9,'铁杆会员',1000),(10,'知名人士',2000),(11,'知名人士',3000),(12,'人气楷模',6000),(13,'人气楷模',10000),(14,'意见领袖',18000),(15,'资深元老',30000),(16,'荣耀元老',60000);

/*Table structure for table `yyshop_circle_mlref` */

DROP TABLE IF EXISTS `yyshop_circle_mlref`;

CREATE TABLE `yyshop_circle_mlref` (
...
/*Data for the table `yyshop_circle_recycle` */

/*Table structure for table `yyshop_circle_thclass` */

DROP TABLE IF EXISTS `yyshop_circle_thclass`;

CREATE TABLE `yyshop_circle_thclass` (
...
/*Data for the table `yyshop_circle_thclass` */

/*Table structure for table `yyshop_circle_theme` */

DROP TABLE IF EXISTS `yyshop_circle_theme`;

CREATE TABLE `yyshop_circle_theme` (
...
/*Data for the table `yyshop_circle_theme` */

/*Table structure for table `yyshop_circle_thg` */

DROP TABLE IF EXISTS `yyshop_circle_thg`;

CREATE TABLE `yyshop_circle_thg` (
...
/*Data for the table `yyshop_circle_thg` */

/*Table structure for table `yyshop_circle_thpoll` */

DROP TABLE IF EXISTS `yyshop_circle_thpoll`;

CREATE TABLE `yyshop_circle_thpoll` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
...
/*Data for the table `yyshop_circle_thpoll` */

/*Table structure for table `yyshop_circle_thpolloption` */

DROP TABLE IF EXISTS `yyshop_circle_thpolloption`;

CREATE TABLE `yyshop_circle_thpolloption` (
...
/*Data for the table `yyshop_circle_thpolloption` */

/*Table structure for table `yyshop_circle_thpollvoter` */

DROP TABLE IF EXISTS `yyshop_circle_thpollvoter`;

CREATE TABLE `yyshop_circle_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
...
/*Data for the table `yyshop_circle_thpollvoter` */

/*Table structure for table `yyshop_cms_article` */

DROP TABLE IF EXISTS `yyshop_cms_article`;

CREATE TABLE `yyshop_cms_article` (
...
/*Data for the table `yyshop_cms_article` */

/*Table structure for table `yyshop_cms_article_attitude` */

DROP TABLE IF EXISTS `yyshop_cms_article_attitude`;

CREATE TABLE `yyshop_cms_article_attitude` (
...
/*Data for the table `yyshop_cms_article_attitude` */

/*Table structure for table `yyshop_cms_article_class` */

DROP TABLE IF EXISTS `yyshop_cms_article_class`;

CREATE TABLE `yyshop_cms_article_class` (
...
/*Data for the table `yyshop_cms_article_class` */

/*Table structure for table `yyshop_cms_comment` */

DROP TABLE IF EXISTS `yyshop_cms_comment`;

CREATE TABLE `yyshop_cms_comment` (
...
/*Data for the table `yyshop_cms_comment` */

/*Table structure for table `yyshop_cms_comment_up` */

DROP TABLE IF EXISTS `yyshop_cms_comment_up`;

CREATE TABLE `yyshop_cms_comment_up` (
...
/*Data for the table `yyshop_cms_comment_up` */

/*Table structure for table `yyshop_cms_index_module` */

DROP TABLE IF EXISTS `yyshop_cms_index_module`;

CREATE TABLE `yyshop_cms_index_module` (
...
/*Data for the table `yyshop_cms_index_module` */

/*Table structure for table `yyshop_cms_module` */

DROP TABLE IF EXISTS `yyshop_cms_module`;

CREATE TABLE `yyshop_cms_module` (
...
/*Data for the table `yyshop_cms_module` */

insert  into `yyshop_cms_module`(`module_id`,`module_title`,`module_name`,`module_type`,`module_class`) values (1,'综合模块','index','index',1),(2,'微商城模块','micro','micro',1),(3,'文章模块1','article1','article1',1),(4,'文章模块2','article2','article2',1),(5,'通栏广告模块','adv','adv',1);

/*Table structure for table `yyshop_cms_module_assembly` */

DROP TABLE IF EXISTS `yyshop_cms_module_assembly`;

CREATE TABLE `yyshop_cms_module_assembly` (
...
/*Data for the table `yyshop_cms_module_assembly` */

insert  into `yyshop_cms_module_assembly`(`assembly_id`,`assembly_title`,`assembly_name`,`assembly_explain`) values (1,'文章','article','文章组件'),(2,'图片','picture','图片组件'),(3,'商品','goods','商品组件'),(4,'品牌','brand','品牌组件'),(5,'图文','article_image','图文'),(6,'店铺','store','店铺'),(7,'会员','member','会员'),(8,'FLASH','flash','FLASH'),(9,'自定义','html','自定义');

/*Table structure for table `yyshop_cms_module_frame` */

DROP TABLE IF EXISTS `yyshop_cms_module_frame`;

CREATE TABLE `yyshop_cms_module_frame` (
...
/*Data for the table `yyshop_cms_navigation` */

insert  into `yyshop_cms_navigation`(`navigation_id`,`navigation_title`,`navigation_link`,`navigation_sort`,`navigation_open_type`) values (1,'商城','http://goodshop.com/',255,1),(2,'圈子','http://goodshop.com/circle',255,1),(3,'微商城','http://goodshop.com/microshop',255,1),(4,'品牌','http://goodshop.com/shop/index.php?act=brand',255,1);

/*Table structure for table `yyshop_cms_picture` */

DROP TABLE IF EXISTS `yyshop_cms_picture`;

CREATE TABLE `yyshop_cms_picture` (
...
/*Data for the table `yyshop_cms_picture` */

/*Table structure for table `yyshop_cms_picture_class` */

DROP TABLE IF EXISTS `yyshop_cms_picture_class`;

CREATE TABLE `yyshop_cms_picture_class` (
  `class_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(1) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`class_id`)
...
/*Data for the table `yyshop_cms_picture_class` */

/*Table structure for table `yyshop_cms_picture_image` */

DROP TABLE IF EXISTS `yyshop_cms_picture_image`;

CREATE TABLE `yyshop_cms_picture_image` (
...
/*Data for the table `yyshop_cms_picture_image` */

/*Table structure for table `yyshop_cms_special` */

DROP TABLE IF EXISTS `yyshop_cms_special`;

CREATE TABLE `yyshop_cms_special` (
...
/*Data for the table `yyshop_cms_special` */

/*Table structure for table `yyshop_cms_tag` */

DROP TABLE IF EXISTS `yyshop_cms_tag`;

CREATE TABLE `yyshop_cms_tag` (
...
/*Data for the table `yyshop_cms_tag` */

/*Table structure for table `yyshop_cms_tag_relation` */

DROP TABLE IF EXISTS `yyshop_cms_tag_relation`;

CREATE TABLE `yyshop_cms_tag_relation` (
...
/*Data for the table `yyshop_cms_tag_relation` */

/*Table structure for table `yyshop_complain` */

DROP TABLE IF EXISTS `yyshop_complain`;

CREATE TABLE `yyshop_complain` (
...
/*Data for the table `yyshop_complain` */

/*Table structure for table `yyshop_complain_subject` */

DROP TABLE IF EXISTS `yyshop_complain_subject`;

CREATE TABLE `yyshop_complain_subject` (
...
/*Data for the table `yyshop_complain_subject` */

insert  into `yyshop_complain_subject`(`complain_subject_id`,`complain_subject_content`,`complain_subject_desc`,`complain_subject_state`) values (1,'商家不同意退款','买家申请退款被拒绝。',2),(2,'未收到货','交易成功，未收到货，钱已经付给商家，可进行维权。',1),(3,'售后保障服务','交易完成后30天内，在使用商品过程中，发现商品有质量问题或无法正常使用，可进行维权。',1);

/*Table structure for table `yyshop_complain_talk` */

DROP TABLE IF EXISTS `yyshop_complain_talk`;

CREATE TABLE `yyshop_complain_talk` (
...
/*Data for the table `yyshop_complain_talk` */

/*Table structure for table `yyshop_consult` */

DROP TABLE IF EXISTS `yyshop_consult`;

CREATE TABLE `yyshop_consult` (
...
/*Data for the table `yyshop_consult` */

/*Table structure for table `yyshop_consult_type` */

DROP TABLE IF EXISTS `yyshop_consult_type`;

CREATE TABLE `yyshop_consult_type` (
...
/*Data for the table `yyshop_consume` */

/*Table structure for table `yyshop_contract` */

DROP TABLE IF EXISTS `yyshop_contract`;

CREATE TABLE `yyshop_contract` (
...
/*Data for the table `yyshop_contract` */

/*Table structure for table `yyshop_contract_apply` */

DROP TABLE IF EXISTS `yyshop_contract_apply`;

CREATE TABLE `yyshop_contract_apply` (
...
/*Data for the table `yyshop_contract_apply` */

/*Table structure for table `yyshop_contract_costlog` */

DROP TABLE IF EXISTS `yyshop_contract_costlog`;

CREATE TABLE `yyshop_contract_costlog` (
...
/*Data for the table `yyshop_contract_costlog` */

/*Table structure for table `yyshop_contract_item` */

DROP TABLE IF EXISTS `yyshop_contract_item`;

CREATE TABLE `yyshop_contract_item` (
...
/*Data for the table `yyshop_contract_log` */

/*Table structure for table `yyshop_contract_quitapply` */

DROP TABLE IF EXISTS `yyshop_contract_quitapply`;

CREATE TABLE `yyshop_contract_quitapply` (
...
/*Data for the table `yyshop_contract_quitapply` */

/*Table structure for table `yyshop_cron` */

DROP TABLE IF EXISTS `yyshop_cron`;

CREATE TABLE `yyshop_cron` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `yyshop_cron` */

insert  into `yyshop_cron`(`id`,`type`,`exeid`,`exetime`) values (1,7,1,1453392000),(4,6,100009,1453392000);

/*Table structure for table `yyshop_daddress` */

DROP TABLE IF EXISTS `yyshop_daddress`;

CREATE TABLE `yyshop_daddress` (
  `address_id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址ID',
...
/*Data for the table `yyshop_daddress` */

/*Table structure for table `yyshop_delivery_order` */

DROP TABLE IF EXISTS `yyshop_delivery_order`;

CREATE TABLE `yyshop_delivery_order` (
  `order_id` int(11) NOT NULL COMMENT '订单ID',
...
/*Data for the table `yyshop_delivery_order` */

/*Table structure for table `yyshop_delivery_point` */

DROP TABLE IF EXISTS `yyshop_delivery_point`;

CREATE TABLE `yyshop_delivery_point` (
...
/*Data for the table `yyshop_delivery_point` */

/*Table structure for table `yyshop_document` */

DROP TABLE IF EXISTS `yyshop_document`;

CREATE TABLE `yyshop_document` (
...
/*Data for the table `yyshop_evaluate_goods` */

/*Table structure for table `yyshop_evaluate_store` */

DROP TABLE IF EXISTS `yyshop_evaluate_store`;

CREATE TABLE `yyshop_evaluate_store` (
...
/*Data for the table `yyshop_evaluate_store` */

/*Table structure for table `yyshop_exppoints_log` */

DROP TABLE IF EXISTS `yyshop_exppoints_log`;

CREATE TABLE `yyshop_exppoints_log` (
...
/*Data for the table `yyshop_exppoints_log` */

/*Table structure for table `yyshop_express` */

DROP TABLE IF EXISTS `yyshop_express`;

CREATE TABLE `yyshop_express` (
...
/*Data for the table `yyshop_favorites` */

/*Table structure for table `yyshop_flowstat` */

DROP TABLE IF EXISTS `yyshop_flowstat`;

CREATE TABLE `yyshop_flowstat` (
...
/*Data for the table `yyshop_flowstat` */

/*Table structure for table `yyshop_flowstat_1` */

DROP TABLE IF EXISTS `yyshop_flowstat_1`;

CREATE TABLE `yyshop_flowstat_1` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
/*Data for the table `yyshop_flowstat_1` */

/*Table structure for table `yyshop_flowstat_2` */

DROP TABLE IF EXISTS `yyshop_flowstat_2`;

CREATE TABLE `yyshop_flowstat_2` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
/*Data for the table `yyshop_flowstat_2` */

/*Table structure for table `yyshop_gadmin` */

DROP TABLE IF EXISTS `yyshop_gadmin`;

CREATE TABLE `yyshop_gadmin` (
...
/*Data for the table `yyshop_gadmin` */

/*Table structure for table `yyshop_goods` */

DROP TABLE IF EXISTS `yyshop_goods`;

CREATE TABLE `yyshop_goods` (
...
/*Data for the table `yyshop_goods` */

/*Table structure for table `yyshop_goods_attr_index` */

DROP TABLE IF EXISTS `yyshop_goods_attr_index`;

CREATE TABLE `yyshop_goods_attr_index` (
  `goods_id` int(10) unsigned NOT NULL COMMENT '商品id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '商品公共表id',
  `gc_id` int(10) unsigned NOT NULL COMMENT '商品分类id',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
...
/*Data for the table `yyshop_goods_attr_index` */

/*Table structure for table `yyshop_goods_browse` */

DROP TABLE IF EXISTS `yyshop_goods_browse`;

CREATE TABLE `yyshop_goods_browse` (
  `goods_id` int(11) NOT NULL COMMENT '商品ID',
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
/*Data for the table `yyshop_goods_browse` */

/*Table structure for table `yyshop_goods_class` */

DROP TABLE IF EXISTS `yyshop_goods_class`;

CREATE TABLE `yyshop_goods_class` (
...
/*Data for the table `yyshop_goods_class_staple` */

/*Table structure for table `yyshop_goods_class_tag` */

DROP TABLE IF EXISTS `yyshop_goods_class_tag`;

CREATE TABLE `yyshop_goods_class_tag` (
...
/*Data for the table `yyshop_goods_class_tag` */

/*Table structure for table `yyshop_goods_common` */

DROP TABLE IF EXISTS `yyshop_goods_common`;

CREATE TABLE `yyshop_goods_common` (
...
/*Data for the table `yyshop_goods_common` */

/*Table structure for table `yyshop_goods_fcode` */

DROP TABLE IF EXISTS `yyshop_goods_fcode`;

CREATE TABLE `yyshop_goods_fcode` (
...
/*Data for the table `yyshop_goods_fcode` */

/*Table structure for table `yyshop_goods_gift` */

DROP TABLE IF EXISTS `yyshop_goods_gift`;

CREATE TABLE `yyshop_goods_gift` (
...
/*Data for the table `yyshop_goods_gift` */

/*Table structure for table `yyshop_goods_images` */

DROP TABLE IF EXISTS `yyshop_goods_images`;

CREATE TABLE `yyshop_goods_images` (
...
/*Data for the table `yyshop_goods_images` */

/*Table structure for table `yyshop_goods_recommend` */

DROP TABLE IF EXISTS `yyshop_goods_recommend`;

CREATE TABLE `yyshop_goods_recommend` (
...
/*Data for the table `yyshop_goods_recommend` */

/*Table structure for table `yyshop_groupbuy` */

DROP TABLE IF EXISTS `yyshop_groupbuy`;

CREATE TABLE `yyshop_groupbuy` (
...
/*Data for the table `yyshop_groupbuy` */

/*Table structure for table `yyshop_groupbuy_class` */

DROP TABLE IF EXISTS `yyshop_groupbuy_class`;

CREATE TABLE `yyshop_groupbuy_class` (
...
/*Data for the table `yyshop_groupbuy_class` */

/*Table structure for table `yyshop_groupbuy_price_range` */

DROP TABLE IF EXISTS `yyshop_groupbuy_price_range`;

CREATE TABLE `yyshop_groupbuy_price_range` (
...
/*Data for the table `yyshop_groupbuy_price_range` */

/*Table structure for table `yyshop_groupbuy_quota` */

DROP TABLE IF EXISTS `yyshop_groupbuy_quota`;

CREATE TABLE `yyshop_groupbuy_quota` (
...
/*Data for the table `yyshop_groupbuy_quota` */

/*Table structure for table `yyshop_help` */

DROP TABLE IF EXISTS `yyshop_help`;

CREATE TABLE `yyshop_help` (
...
/*Data for the table `yyshop_help_type` */

insert  into `yyshop_help_type`(`type_id`,`type_name`,`type_sort`,`help_code`,`help_show`,`page_show`) values (91,'规则体系',91,'sys_rules',1,1),(92,'商品管理',92,'sys_goods',1,1),(93,'促销方式',93,'sys_sales',1,1),(94,'订单及售后',94,'sys_order',1,1),(95,'店铺续约',95,'sys_renew',1,1),(99,'入驻流程',99,'store_in',1,1);

/*Table structure for table `yyshop_inform` */

DROP TABLE IF EXISTS `yyshop_inform`;

CREATE TABLE `yyshop_inform` (
...
/*Data for the table `yyshop_inform` */

/*Table structure for table `yyshop_inform_subject` */

DROP TABLE IF EXISTS `yyshop_inform_subject`;

CREATE TABLE `yyshop_inform_subject` (
...
/*Data for the table `yyshop_inform_subject` */

insert  into `yyshop_inform_subject`(`inform_subject_id`,`inform_subject_content`,`inform_subject_type_id`,`inform_subject_type_name`,`inform_subject_state`) values (1,'管制刀具、弓弩类、其他武器等',1,'出售禁售品',1),(2,'赌博用具类',1,'出售禁售品',1),(3,'枪支弹药',1,'出售禁售品',1),(4,'毒品及吸毒工具',1,'出售禁售品',1),(5,'色差大，质量差。',2,'产品质量问题',1);

/*Table structure for table `yyshop_inform_subject_type` */

DROP TABLE IF EXISTS `yyshop_inform_subject_type`;

CREATE TABLE `yyshop_inform_subject_type` (
...
/*Data for the table `yyshop_inform_subject_type` */

insert  into `yyshop_inform_subject_type`(`inform_type_id`,`inform_type_name`,`inform_type_desc`,`inform_type_state`) values (1,'出售禁售品','销售商城禁止和限制交易规则下所规定的所有商品。',1),(2,'产品质量问题','产品质量差，与描述严重不相符。',1);

/*Table structure for table `yyshop_invoice` */

DROP TABLE IF EXISTS `yyshop_invoice`;

CREATE TABLE `yyshop_invoice` (
...
/*Data for the table `yyshop_invoice` */

/*Table structure for table `yyshop_link` */

DROP TABLE IF EXISTS `yyshop_link`;

CREATE TABLE `yyshop_link` (
...
/*Data for the table `yyshop_link` */

insert  into `yyshop_link`(`link_id`,`link_title`,`link_url`,`link_pic`,`link_sort`) values (1,'好商城','http://www.33hao.com','33haologo.png',0),(2,'演示站点','http://v5.33hao.com','33haologo.png',1),(3,'支持论坛','http://bbs.33hao.com','',1),(4,'淘宝店','http://33haocom.taobao.com','',0);

/*Table structure for table `yyshop_lock` */

DROP TABLE IF EXISTS `yyshop_lock`;

CREATE TABLE `yyshop_lock` (
...
/*Data for the table `yyshop_lock` */

/*Table structure for table `yyshop_mail_cron` */

DROP TABLE IF EXISTS `yyshop_mail_cron`;

CREATE TABLE `yyshop_mail_cron` (
...
/*Data for the table `yyshop_mail_cron` */

/*Table structure for table `yyshop_mail_msg_temlates` */

DROP TABLE IF EXISTS `yyshop_mail_msg_temlates`;

CREATE TABLE `yyshop_mail_msg_temlates` (
...
/*Data for the table `yyshop_mall_consult` */

/*Table structure for table `yyshop_mall_consult_type` */

DROP TABLE IF EXISTS `yyshop_mall_consult_type`;

CREATE TABLE `yyshop_mall_consult_type` (
...
/*Data for the table `yyshop_mall_consult_type` */

insert  into `yyshop_mall_consult_type`(`mct_id`,`mct_name`,`mct_introduce`,`mct_sort`) values (1,'商品咨询','&lt;p&gt;\r\n  请写明商品链接，或平台货号。\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n   如果您对商品规格、介绍等有疑问，可以在商品详情页“购买咨询”处发起咨询，会得到及时专业的回复。\r\n&lt;/p&gt;',255),(2,'订单咨询','&lt;p&gt;\r\n  请写明要咨询的订单编号。\r\n&lt;/p&gt;\r\n&lt;p&gt;\r\n 如需处理交易中产生的纠纷，请选择投诉。\r\n&lt;/p&gt;',255);

/*Table structure for table `yyshop_mb_category` */

DROP TABLE IF EXISTS `yyshop_mb_category`;

CREATE TABLE `yyshop_mb_category` (
...
/*Data for the table `yyshop_mb_category` */

insert  into `yyshop_mb_category`(`gc_id`,`gc_thumb`) values (1,'05015381809285330.png'),(2,'05015381349504237.png'),(3,'05015381681266734.png'),(256,'05015381190111257.png'),(308,'05015382063902705.png'),(470,'05015382211209809.png'),(530,'05015382869763762.png'),(593,'05015382413708016.png'),(730,'05015382972892418.png'),(825,'05015383078446336.png'),(888,'05015382679643040.png'),(959,'05015383177958780.png'),(1037,'05015383410379550.png');

/*Table structure for table `yyshop_mb_feedback` */

DROP TABLE IF EXISTS `yyshop_mb_feedback`;

CREATE TABLE `yyshop_mb_feedback` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `yyshop_mb_feedback` */

/*Table structure for table `yyshop_mb_payment` */

DROP TABLE IF EXISTS `yyshop_mb_payment`;

CREATE TABLE `yyshop_mb_payment` (
...
/*Data for the table `yyshop_mb_payment` */

insert  into `yyshop_mb_payment`(`payment_id`,`payment_code`,`payment_name`,`payment_config`,`payment_state`) values (1,'alipay','支付宝','a:3:{s:14:\"alipay_account\";s:1:\"1\";s:10:\"alipay_key\";s:1:\"1\";s:14:\"alipay_partner\";s:1:\"1\";}','1'),(2,'wxpay','微信支付','','0'),(3,'wxpay_jsapi','微信支付JSAPI','a:4:{s:5:\"appId\";s:1:\"1\";s:9:\"appSecret\";s:1:\"1\";s:9:\"partnerId\";s:1:\"1\";s:6:\"apiKey\";s:1:\"1\";}','1'),(4,'alipay_native','支付宝移动支付','','0');

/*Table structure for table `yyshop_mb_seller_token` */

DROP TABLE IF EXISTS `yyshop_mb_seller_token`;

CREATE TABLE `yyshop_mb_seller_token` (
...
/*Data for the table `yyshop_mb_seller_token` */

/*Table structure for table `yyshop_mb_special` */

DROP TABLE IF EXISTS `yyshop_mb_special`;

CREATE TABLE `yyshop_mb_special` (
  `special_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '专题编号',
  `special_desc` varchar(20) NOT NULL COMMENT '专题描述',
  PRIMARY KEY (`special_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='手机专题表';

/*Data for the table `yyshop_mb_special` */

/*Table structure for table `yyshop_mb_special_item` */

DROP TABLE IF EXISTS `yyshop_mb_special_item`;

CREATE TABLE `yyshop_mb_special_item` (
...
/*Data for the table `yyshop_mb_user_token` */

/*Table structure for table `yyshop_member` */

DROP TABLE IF EXISTS `yyshop_member`;

CREATE TABLE `yyshop_member` (
...
/*Data for the table `yyshop_member` */

insert  into `yyshop_member`(`member_id`,`member_name`,`member_truename`,`member_avatar`,`member_sex`,`member_birthday`,`member_passwd`,`member_paypwd`,`member_email`,`member_email_bind`,`member_mobile`,`member_mobile_bind`,`member_qq`,`member_ww`,`member_login_num`,`member_time`,`member_login_time`,`member_old_login_time`,`member_login_ip`,`member_old_login_ip`,`member_qqopenid`,`member_qqinfo`,`member_sinaopenid`,`member_sinainfo`,`weixin_unionid`,`weixin_info`,`member_points`,`available_predeposit`,`freeze_predeposit`,`available_rc_balance`,`freeze_rc_balance`,`inform_allow`,`is_buy`,`is_allowtalk`,`member_state`,`member_snsvisitnum`,`member_areaid`,`member_cityid`,`member_provinceid`,`member_areainfo`,`member_privacy`,`member_exppoints`,`invite_one`,`invite_two`,`invite_three`,`inviter_id`) values (1,'user11',NULL,NULL,NULL,NULL,'670b14728ad9902aecba32e22fa4f6bd',NULL,'',0,NULL,0,NULL,NULL,1,'1546071170','1546071170','1546071170',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,'0.00','0.00','0.00','0.00',1,1,1,1,0,NULL,NULL,NULL,NULL,NULL,0,0,0,0,NULL);

/*Table structure for table `yyshop_member_common` */

DROP TABLE IF EXISTS `yyshop_member_common`;

CREATE TABLE `yyshop_member_common` (
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
/*Data for the table `yyshop_member_common` */

insert  into `yyshop_member_common`(`member_id`,`auth_code`,`send_acode_time`,`send_mb_time`,`send_email_time`,`send_mb_times`,`send_acode_times`,`auth_code_check_times`,`auth_modify_pwd_time`) values (1,NULL,0,NULL,NULL,0,0,0,0);

/*Table structure for table `yyshop_member_msg_setting` */

DROP TABLE IF EXISTS `yyshop_member_msg_setting`;

CREATE TABLE `yyshop_member_msg_setting` (
...
/*Data for the table `yyshop_member_msg_setting` */

/*Table structure for table `yyshop_member_msg_tpl` */

DROP TABLE IF EXISTS `yyshop_member_msg_tpl`;

CREATE TABLE `yyshop_member_msg_tpl` (
  `mmt_code` varchar(50) NOT NULL COMMENT '用户消息模板编号',
...
/*Data for the table `yyshop_message` */

/*Table structure for table `yyshop_micro_adv` */

DROP TABLE IF EXISTS `yyshop_micro_adv`;

CREATE TABLE `yyshop_micro_adv` (
...
/*Data for the table `yyshop_micro_adv` */

/*Table structure for table `yyshop_micro_comment` */

DROP TABLE IF EXISTS `yyshop_micro_comment`;

CREATE TABLE `yyshop_micro_comment` (
  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论编号',
  `comment_type` tinyint(1) NOT NULL COMMENT '评论类型编号',
  `comment_object_id` int(10) unsigned NOT NULL COMMENT '推荐商品编号',
...
/*Data for the table `yyshop_micro_comment` */

/*Table structure for table `yyshop_micro_goods` */

DROP TABLE IF EXISTS `yyshop_micro_goods`;

CREATE TABLE `yyshop_micro_goods` (
...
/*Data for the table `yyshop_micro_goods` */

/*Table structure for table `yyshop_micro_goods_class` */

DROP TABLE IF EXISTS `yyshop_micro_goods_class`;

CREATE TABLE `yyshop_micro_goods_class` (
...
/*Data for the table `yyshop_micro_goods_class` */

/*Table structure for table `yyshop_micro_goods_relation` */

DROP TABLE IF EXISTS `yyshop_micro_goods_relation`;

CREATE TABLE `yyshop_micro_goods_relation` (
  `relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '关系编号',
...
/*Data for the table `yyshop_micro_goods_relation` */

/*Table structure for table `yyshop_micro_like` */

DROP TABLE IF EXISTS `yyshop_micro_like`;

CREATE TABLE `yyshop_micro_like` (
...
/*Data for the table `yyshop_micro_like` */

/*Table structure for table `yyshop_micro_member_info` */

DROP TABLE IF EXISTS `yyshop_micro_member_info`;

CREATE TABLE `yyshop_micro_member_info` (
...
/*Data for the table `yyshop_micro_member_info` */

/*Table structure for table `yyshop_micro_personal` */

DROP TABLE IF EXISTS `yyshop_micro_personal`;

CREATE TABLE `yyshop_micro_personal` (
...
/*Data for the table `yyshop_micro_personal` */

/*Table structure for table `yyshop_micro_personal_class` */

DROP TABLE IF EXISTS `yyshop_micro_personal_class`;

CREATE TABLE `yyshop_micro_personal_class` (
  `class_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(4) unsigned NOT NULL COMMENT '排序',
  `class_image` varchar(100) DEFAULT '' COMMENT '分类图片',
...
/*Data for the table `yyshop_micro_personal_class` */

/*Table structure for table `yyshop_micro_store` */

DROP TABLE IF EXISTS `yyshop_micro_store`;

CREATE TABLE `yyshop_micro_store` (
...
/*Data for the table `yyshop_micro_store` */

/*Table structure for table `yyshop_navigation` */

DROP TABLE IF EXISTS `yyshop_navigation`;

CREATE TABLE `yyshop_navigation` (
...
/*Data for the table `yyshop_navigation` */

insert  into `yyshop_navigation`(`nav_id`,`nav_type`,`nav_title`,`nav_url`,`nav_location`,`nav_new_open`,`nav_sort`,`item_id`) values (6,0,'关于我们','http://goodshop.com/member/index.php?act=article&article_id=22',2,0,255,0),(7,0,'联系我们','http://goodshop.com/member/index.php?act=article&article_id=23',2,0,240,0),(8,0,'合作及洽谈','http://goodshop.com/member/index.php?act=article&article_id=25',2,0,220,0),(9,0,'招聘英才','http://goodshop.com/member/index.php?act=article&article_id=24',2,0,210,0),(10,0,'店铺','http://goodshop.com/index.php?act=store_list&op=index',1,0,5,0),(11,0,'门户','http://goodshop.com/cms',1,0,6,0),(12,0,'圈子','http://goodshop.com/circle',1,0,7,0),(13,0,'微商城','http://goodshop.com/microshop',1,0,8,0),(15,0,'物流自取','http://goodshop.com/delivery',2,0,255,0),(16,0,'友情链接','http://goodshop.com/index.php?act=link',2,0,255,0),(17,0,'抢购','http://goodshop.com/index.php?act=show_groupbuy',1,0,1,0),(18,0,'品牌','http://goodshop.com/index.php?act=brand',1,0,2,0),(19,0,'打折促销','http://goodshop.com/index.php?act=promotion',1,0,3,0),(20,0,'积分兑换','http://goodshop.com/index.php?act=pointshop',1,0,4,0),(21,0,'专题活动','http://goodshop.com/index.php?act=special',1,0,5,0);

/*Table structure for table `yyshop_offpay_area` */

DROP TABLE IF EXISTS `yyshop_offpay_area`;

CREATE TABLE `yyshop_offpay_area` (
...
/*Data for the table `yyshop_offpay_area` */

/*Table structure for table `yyshop_order_bill` */

DROP TABLE IF EXISTS `yyshop_order_bill`;

CREATE TABLE `yyshop_order_bill` (
...
/*Data for the table `yyshop_order_bill` */

/*Table structure for table `yyshop_order_book` */

DROP TABLE IF EXISTS `yyshop_order_book`;

CREATE TABLE `yyshop_order_book` (
...
/*Data for the table `yyshop_order_book` */

/*Table structure for table `yyshop_order_common` */

DROP TABLE IF EXISTS `yyshop_order_common`;

CREATE TABLE `yyshop_order_common` (
...
/*Data for the table `yyshop_order_common` */

/*Table structure for table `yyshop_order_goods` */

DROP TABLE IF EXISTS `yyshop_order_goods`;

CREATE TABLE `yyshop_order_goods` (
...
/*Data for the table `yyshop_order_goods` */

/*Table structure for table `yyshop_order_log` */

DROP TABLE IF EXISTS `yyshop_order_log`;

CREATE TABLE `yyshop_order_log` (
...
/*Data for the table `yyshop_order_log` */

/*Table structure for table `yyshop_order_pay` */

DROP TABLE IF EXISTS `yyshop_order_pay`;

CREATE TABLE `yyshop_order_pay` (
...
/*Data for the table `yyshop_order_pay` */

/*Table structure for table `yyshop_order_snapshot` */

DROP TABLE IF EXISTS `yyshop_order_snapshot`;

CREATE TABLE `yyshop_order_snapshot` (
...
/*Data for the table `yyshop_order_snapshot` */

/*Table structure for table `yyshop_order_statis` */

DROP TABLE IF EXISTS `yyshop_order_statis`;

CREATE TABLE `yyshop_order_statis` (
...
/*Data for the table `yyshop_order_statis` */

/*Table structure for table `yyshop_orders` */

DROP TABLE IF EXISTS `yyshop_orders`;

CREATE TABLE `yyshop_orders` (
...
/*Data for the table `yyshop_orders` */

/*Table structure for table `yyshop_p_book_quota` */

DROP TABLE IF EXISTS `yyshop_p_book_quota`;

CREATE TABLE `yyshop_p_book_quota` (
...
/*Data for the table `yyshop_p_book_quota` */

/*Table structure for table `yyshop_p_booth_goods` */

DROP TABLE IF EXISTS `yyshop_p_booth_goods`;

CREATE TABLE `yyshop_p_booth_goods` (
...
/*Data for the table `yyshop_p_booth_goods` */

/*Table structure for table `yyshop_p_booth_quota` */

DROP TABLE IF EXISTS `yyshop_p_booth_quota`;

CREATE TABLE `yyshop_p_booth_quota` (
...
/*Data for the table `yyshop_p_booth_quota` */

/*Table structure for table `yyshop_p_bundling` */

DROP TABLE IF EXISTS `yyshop_p_bundling`;

CREATE TABLE `yyshop_p_bundling` (
...
/*Data for the table `yyshop_p_bundling` */

/*Table structure for table `yyshop_p_bundling_goods` */

DROP TABLE IF EXISTS `yyshop_p_bundling_goods`;

CREATE TABLE `yyshop_p_bundling_goods` (
...
/*Data for the table `yyshop_p_bundling_goods` */

/*Table structure for table `yyshop_p_bundling_quota` */

DROP TABLE IF EXISTS `yyshop_p_bundling_quota`;

CREATE TABLE `yyshop_p_bundling_quota` (
...
/*Data for the table `yyshop_p_bundling_quota` */

/*Table structure for table `yyshop_p_combo_goods` */

DROP TABLE IF EXISTS `yyshop_p_combo_goods`;

CREATE TABLE `yyshop_p_combo_goods` (
...
/*Data for the table `yyshop_p_combo_goods` */

/*Table structure for table `yyshop_p_combo_quota` */

DROP TABLE IF EXISTS `yyshop_p_combo_quota`;

CREATE TABLE `yyshop_p_combo_quota` (
...
/*Data for the table `yyshop_p_combo_quota` */

/*Table structure for table `yyshop_p_cou` */

DROP TABLE IF EXISTS `yyshop_p_cou`;

CREATE TABLE `yyshop_p_cou` (
...
/*Data for the table `yyshop_p_cou` */

/*Table structure for table `yyshop_p_cou_level` */

DROP TABLE IF EXISTS `yyshop_p_cou_level`;

CREATE TABLE `yyshop_p_cou_level` (
...
/*Data for the table `yyshop_p_cou_level` */

/*Table structure for table `yyshop_p_cou_level_sku` */

DROP TABLE IF EXISTS `yyshop_p_cou_level_sku`;

CREATE TABLE `yyshop_p_cou_level_sku` (
  `cou_id` int(11) NOT NULL COMMENT '加价购ID',
  `xlevel` tinyint(3) unsigned NOT NULL COMMENT '等级',
...
/*Data for the table `yyshop_p_cou_level_sku` */

/*Table structure for table `yyshop_p_cou_quota` */

DROP TABLE IF EXISTS `yyshop_p_cou_quota`;

CREATE TABLE `yyshop_p_cou_quota` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `store_id` int(11) NOT NULL COMMENT '店铺ID',
  `store_name` varchar(50) NOT NULL COMMENT '店铺名称',
  `tstart` int(10) unsigned NOT NULL COMMENT '开始时间',
...
/*Data for the table `yyshop_p_cou_quota` */

/*Table structure for table `yyshop_p_cou_sku` */

DROP TABLE IF EXISTS `yyshop_p_cou_sku`;

CREATE TABLE `yyshop_p_cou_sku` (
  `sku_id` int(11) NOT NULL COMMENT '商品条目ID',
  `cou_id` int(11) NOT NULL COMMENT '加价购ID',
  `tstart` int(10) unsigned NOT NULL COMMENT '开始时间',
  `tend` int(10) unsigned NOT NULL COMMENT '结束时间',
...
/*Data for the table `yyshop_p_cou_sku` */

/*Table structure for table `yyshop_p_fcode_quota` */

DROP TABLE IF EXISTS `yyshop_p_fcode_quota`;

CREATE TABLE `yyshop_p_fcode_quota` (
...
/*Data for the table `yyshop_p_fcode_quota` */

/*Table structure for table `yyshop_p_mansong` */

DROP TABLE IF EXISTS `yyshop_p_mansong`;

CREATE TABLE `yyshop_p_mansong` (
...
/*Data for the table `yyshop_p_mansong` */

/*Table structure for table `yyshop_p_mansong_quota` */

DROP TABLE IF EXISTS `yyshop_p_mansong_quota`;

CREATE TABLE `yyshop_p_mansong_quota` (
...
/*Data for the table `yyshop_p_mansong_quota` */

/*Table structure for table `yyshop_p_mansong_rule` */

DROP TABLE IF EXISTS `yyshop_p_mansong_rule`;

CREATE TABLE `yyshop_p_mansong_rule` (
...
/*Data for the table `yyshop_p_mansong_rule` */

/*Table structure for table `yyshop_p_sole_goods` */

DROP TABLE IF EXISTS `yyshop_p_sole_goods`;

CREATE TABLE `yyshop_p_sole_goods` (
...
/*Data for the table `yyshop_p_sole_goods` */

/*Table structure for table `yyshop_p_sole_quota` */

DROP TABLE IF EXISTS `yyshop_p_sole_quota`;

CREATE TABLE `yyshop_p_sole_quota` (
...
/*Data for the table `yyshop_p_sole_quota` */

/*Table structure for table `yyshop_p_xianshi` */

DROP TABLE IF EXISTS `yyshop_p_xianshi`;

CREATE TABLE `yyshop_p_xianshi` (
...
/*Data for the table `yyshop_p_xianshi` */

/*Table structure for table `yyshop_p_xianshi_goods` */

DROP TABLE IF EXISTS `yyshop_p_xianshi_goods`;

CREATE TABLE `yyshop_p_xianshi_goods` (
...
/*Data for the table `yyshop_p_xianshi_goods` */

/*Table structure for table `yyshop_p_xianshi_quota` */

DROP TABLE IF EXISTS `yyshop_p_xianshi_quota`;

CREATE TABLE `yyshop_p_xianshi_quota` (
...
/*Data for the table `yyshop_p_xianshi_quota` */

/*Table structure for table `yyshop_payment` */

DROP TABLE IF EXISTS `yyshop_payment`;

CREATE TABLE `yyshop_payment` (
  `payment_id` tinyint(1) unsigned NOT NULL COMMENT '支付索引id',
...
/*Data for the table `yyshop_payment` */

insert  into `yyshop_payment`(`payment_id`,`payment_code`,`payment_name`,`payment_config`,`payment_state`) values (1,'offline','货到付款','a:1:{s:0:\"\";s:0:\"\";}','0'),(2,'alipay','支付宝','a:4:{s:14:\"alipay_service\";s:25:\"create_direct_pay_by_user\";s:14:\"alipay_account\";s:0:\"\";s:10:\"alipay_key\";s:0:\"\";s:14:\"alipay_partner\";s:0:\"\";}','0'),(3,'tenpay','财付通','a:2:{s:14:\"tenpay_account\";s:0:\"\";s:10:\"tenpay_key\";s:0:\"\";}','0'),(4,'chinabank','网银在线','a:2:{s:17:\"chinabank_account\";s:0:\"\";s:13:\"chinabank_key\";s:0:\"\";}','0'),(5,'predeposit','站内余额支付','a:1:{s:0:\"\";s:0:\"\";}','1'),(6,'wxpay','微信支付','a:3:{s:5:\"appid\";s:0:\"\";s:5:\"mchid\";s:0:\"\";s:3:\"key\";s:0:\"\";}','0');

/*Table structure for table `yyshop_pd_cash` */

DROP TABLE IF EXISTS `yyshop_pd_cash`;

CREATE TABLE `yyshop_pd_cash` (
...
/*Data for the table `yyshop_pd_cash` */

/*Table structure for table `yyshop_pd_log` */

DROP TABLE IF EXISTS `yyshop_pd_log`;

CREATE TABLE `yyshop_pd_log` (
...
/*Data for the table `yyshop_pd_log` */

/*Table structure for table `yyshop_pd_recharge` */

DROP TABLE IF EXISTS `yyshop_pd_recharge`;

CREATE TABLE `yyshop_pd_recharge` (
...
/*Data for the table `yyshop_pd_recharge` */

/*Table structure for table `yyshop_points_cart` */

DROP TABLE IF EXISTS `yyshop_points_cart`;

CREATE TABLE `yyshop_points_cart` (
...
/*Data for the table `yyshop_points_cart` */

/*Table structure for table `yyshop_points_goods` */

DROP TABLE IF EXISTS `yyshop_points_goods`;

CREATE TABLE `yyshop_points_goods` (
...
/*Data for the table `yyshop_points_goods` */

/*Table structure for table `yyshop_points_log` */

DROP TABLE IF EXISTS `yyshop_points_log`;

CREATE TABLE `yyshop_points_log` (
...
/*Data for the table `yyshop_points_log` */

/*Table structure for table `yyshop_points_order` */

DROP TABLE IF EXISTS `yyshop_points_order`;

CREATE TABLE `yyshop_points_order` (
...
/*Data for the table `yyshop_points_order` */

/*Table structure for table `yyshop_points_orderaddress` */

DROP TABLE IF EXISTS `yyshop_points_orderaddress`;

CREATE TABLE `yyshop_points_orderaddress` (
...
/*Data for the table `yyshop_points_orderaddress` */

/*Table structure for table `yyshop_points_ordergoods` */

DROP TABLE IF EXISTS `yyshop_points_ordergoods`;

CREATE TABLE `yyshop_points_ordergoods` (
...
/*Data for the table `yyshop_points_ordergoods` */

/*Table structure for table `yyshop_rcb_log` */

DROP TABLE IF EXISTS `yyshop_rcb_log`;

CREATE TABLE `yyshop_rcb_log` (
...
/*Data for the table `yyshop_rcb_log` */

/*Table structure for table `yyshop_rec_position` */

DROP TABLE IF EXISTS `yyshop_rec_position`;

CREATE TABLE `yyshop_rec_position` (
...
/*Data for the table `yyshop_rec_position` */

/*Table structure for table `yyshop_rechargecard` */

DROP TABLE IF EXISTS `yyshop_rechargecard`;

CREATE TABLE `yyshop_rechargecard` (
...
/*Data for the table `yyshop_rechargecard` */

/*Table structure for table `yyshop_redpacket` */

DROP TABLE IF EXISTS `yyshop_redpacket`;

CREATE TABLE `yyshop_redpacket` (
...
/*Data for the table `yyshop_redpacket` */

/*Table structure for table `yyshop_redpacket_template` */

DROP TABLE IF EXISTS `yyshop_redpacket_template`;

CREATE TABLE `yyshop_redpacket_template` (
...
/*Data for the table `yyshop_redpacket_template` */

/*Table structure for table `yyshop_refund_detail` */

DROP TABLE IF EXISTS `yyshop_refund_detail`;

CREATE TABLE `yyshop_refund_detail` (
...
/*Data for the table `yyshop_refund_detail` */

/*Table structure for table `yyshop_refund_reason` */

DROP TABLE IF EXISTS `yyshop_refund_reason`;

CREATE TABLE `yyshop_refund_reason` (
...
/*Data for the table `yyshop_refund_reason` */

insert  into `yyshop_refund_reason`(`reason_id`,`reason_info`,`sort`,`update_time`) values (95,'效果不好不喜欢',123,1496590271),(96,'商品破损、有污渍',123,1496590271),(97,'保质期不符',123,1496590271),(98,'认为是假货',123,1496590271),(99,'不能按时发货',123,1496590271);

/*Table structure for table `yyshop_refund_return` */

DROP TABLE IF EXISTS `yyshop_refund_return`;

CREATE TABLE `yyshop_refund_return` (
...
/*Data for the table `yyshop_refund_return` */

/*Table structure for table `yyshop_seller` */

DROP TABLE IF EXISTS `yyshop_seller`;

CREATE TABLE `yyshop_seller` (
...
/*Data for the table `yyshop_seller` */

insert  into `yyshop_seller`(`seller_id`,`seller_name`,`member_id`,`seller_group_id`,`store_id`,`is_admin`,`seller_quicklink`,`last_login_time`,`is_client`) values (1,'seller11',1,0,1,1,NULL,NULL,0);

/*Table structure for table `yyshop_seller_group` */

DROP TABLE IF EXISTS `yyshop_seller_group`;

CREATE TABLE `yyshop_seller_group` (
...
/*Data for the table `yyshop_seller_group` */

/*Table structure for table `yyshop_seller_group_bclass` */

DROP TABLE IF EXISTS `yyshop_seller_group_bclass`;

CREATE TABLE `yyshop_seller_group_bclass` (
...
/*Data for the table `yyshop_seller_group_bclass` */

/*Table structure for table `yyshop_seller_log` */

DROP TABLE IF EXISTS `yyshop_seller_log`;

CREATE TABLE `yyshop_seller_log` (
...
/*Data for the table `yyshop_seller_log` */

/*Table structure for table `yyshop_seo` */

DROP TABLE IF EXISTS `yyshop_seo`;

CREATE TABLE `yyshop_seo` (
...
/*Data for the table `yyshop_signin` */

/*Table structure for table `yyshop_sms_log` */

DROP TABLE IF EXISTS `yyshop_sms_log`;

CREATE TABLE `yyshop_sms_log` (
  `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
/*Data for the table `yyshop_sms_log` */

/*Table structure for table `yyshop_sns_albumclass` */

DROP TABLE IF EXISTS `yyshop_sns_albumclass`;

CREATE TABLE `yyshop_sns_albumclass` (
...
/*Data for the table `yyshop_sns_albumclass` */

/*Table structure for table `yyshop_sns_albumpic` */

DROP TABLE IF EXISTS `yyshop_sns_albumpic`;

CREATE TABLE `yyshop_sns_albumpic` (
...
/*Data for the table `yyshop_sns_albumpic` */

/*Table structure for table `yyshop_sns_binding` */

DROP TABLE IF EXISTS `yyshop_sns_binding`;

CREATE TABLE `yyshop_sns_binding` (
...
/*Data for the table `yyshop_sns_binding` */

/*Table structure for table `yyshop_sns_comment` */

DROP TABLE IF EXISTS `yyshop_sns_comment`;

CREATE TABLE `yyshop_sns_comment` (
...
/*Data for the table `yyshop_sns_comment` */

/*Table structure for table `yyshop_sns_friend` */

DROP TABLE IF EXISTS `yyshop_sns_friend`;

CREATE TABLE `yyshop_sns_friend` (
...
/*Data for the table `yyshop_sns_friend` */

/*Table structure for table `yyshop_sns_goods` */

DROP TABLE IF EXISTS `yyshop_sns_goods`;

CREATE TABLE `yyshop_sns_goods` (
...
/*Data for the table `yyshop_sns_goods` */

/*Table structure for table `yyshop_sns_membertag` */

DROP TABLE IF EXISTS `yyshop_sns_membertag`;

CREATE TABLE `yyshop_sns_membertag` (
...
/*Data for the table `yyshop_sns_membertag` */

/*Table structure for table `yyshop_sns_mtagmember` */

DROP TABLE IF EXISTS `yyshop_sns_mtagmember`;

CREATE TABLE `yyshop_sns_mtagmember` (
...
/*Data for the table `yyshop_sns_mtagmember` */

/*Table structure for table `yyshop_sns_setting` */

DROP TABLE IF EXISTS `yyshop_sns_setting`;

CREATE TABLE `yyshop_sns_setting` (
  `member_id` int(11) NOT NULL COMMENT '会员id',
  `setting_skin` varchar(50) DEFAULT NULL COMMENT '皮肤',
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人中心设置表';

/*Data for the table `yyshop_sns_setting` */

/*Table structure for table `yyshop_sns_sharegoods` */

DROP TABLE IF EXISTS `yyshop_sns_sharegoods`;

CREATE TABLE `yyshop_sns_sharegoods` (
...
/*Data for the table `yyshop_sns_sharegoods` */

/*Table structure for table `yyshop_sns_sharestore` */

DROP TABLE IF EXISTS `yyshop_sns_sharestore`;

CREATE TABLE `yyshop_sns_sharestore` (
  `share_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
/*Data for the table `yyshop_sns_sharestore` */

/*Table structure for table `yyshop_sns_tracelog` */

DROP TABLE IF EXISTS `yyshop_sns_tracelog`;

CREATE TABLE `yyshop_sns_tracelog` (
...
/*Data for the table `yyshop_sns_tracelog` */

/*Table structure for table `yyshop_sns_visitor` */

DROP TABLE IF EXISTS `yyshop_sns_visitor`;

CREATE TABLE `yyshop_sns_visitor` (
...
/*Data for the table `yyshop_sns_visitor` */

/*Table structure for table `yyshop_spec` */

DROP TABLE IF EXISTS `yyshop_spec`;

CREATE TABLE `yyshop_spec` (
...
/*Data for the table `yyshop_spec` */

insert  into `yyshop_spec`(`sp_id`,`sp_name`,`sp_sort`,`class_id`,`class_name`) values (1,'颜色',0,0,'');

/*Table structure for table `yyshop_spec_value` */

DROP TABLE IF EXISTS `yyshop_spec_value`;

CREATE TABLE `yyshop_spec_value` (
...
/*Data for the table `yyshop_spec_value` */

/*Table structure for table `yyshop_stat_member` */

DROP TABLE IF EXISTS `yyshop_stat_member`;

CREATE TABLE `yyshop_stat_member` (
...
/*Data for the table `yyshop_stat_member` */

/*Table structure for table `yyshop_stat_order` */

DROP TABLE IF EXISTS `yyshop_stat_order`;

CREATE TABLE `yyshop_stat_order` (
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `order_sn` bigint(20) unsigned NOT NULL COMMENT '订单编号',
...
/*Data for the table `yyshop_stat_order` */

/*Table structure for table `yyshop_stat_ordergoods` */

DROP TABLE IF EXISTS `yyshop_stat_ordergoods`;

CREATE TABLE `yyshop_stat_ordergoods` (
...
/*Data for the table `yyshop_stat_ordergoods` */

/*Table structure for table `yyshop_store` */

DROP TABLE IF EXISTS `yyshop_store`;

CREATE TABLE `yyshop_store` (
...
/*Data for the table `yyshop_store` */

insert  into `yyshop_store`(`store_id`,`store_name`,`grade_id`,`member_id`,`member_name`,`seller_name`,`sc_id`,`store_company_name`,`province_id`,`area_info`,`store_address`,`store_zip`,`store_state`,`store_close_info`,`store_sort`,`store_time`,`store_end_time`,`store_label`,`store_banner`,`store_avatar`,`store_keywords`,`store_description`,`store_qq`,`store_ww`,`store_phone`,`store_zy`,`store_domain`,`store_domain_times`,`store_recommend`,`store_theme`,`store_credit`,`store_desccredit`,`store_servicecredit`,`store_deliverycredit`,`store_collect`,`store_slide`,`store_slide_url`,`store_stamp`,`store_printdesc`,`store_sales`,`store_presales`,`store_aftersales`,`store_workingtime`,`store_free_price`,`store_decoration_switch`,`store_decoration_only`,`store_decoration_image_count`,`is_own_shop`,`bind_all_gc`,`store_vrcode_prefix`,`mb_title_img`,`mb_sliders`,`left_bar_type`,`deliver_region`,`is_distribution`,`is_person`) values (1,'myShop',0,1,'user11','seller11',0,NULL,0,'','','',1,NULL,0,'1546071170',NULL,NULL,NULL,NULL,'','',NULL,NULL,NULL,NULL,NULL,0,0,'default',0,0,0,0,0,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,'0.00',0,0,0,1,1,NULL,NULL,NULL,1,NULL,0,0);

/*Table structure for table `yyshop_store_bind_class` */

DROP TABLE IF EXISTS `yyshop_store_bind_class`;

CREATE TABLE `yyshop_store_bind_class` (
  `bid` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `yyshop_store_bind_class` */

/*Table structure for table `yyshop_store_class` */

DROP TABLE IF EXISTS `yyshop_store_class`;

CREATE TABLE `yyshop_store_class` (
...
/*Data for the table `yyshop_store_class` */

insert  into `yyshop_store_class`(`sc_id`,`sc_name`,`sc_bail`,`sc_sort`) values (1,'珠宝/首饰',0,8),(2,'服装鞋包',0,1),(3,'3C数码',0,2),(4,'美容护理',0,3),(5,'家居用品',0,4),(6,'食品/保健',0,5),(7,'母婴用品',0,6),(8,'文体/汽车',0,7),(9,'收藏/爱好',0,9),(10,'生活/服务',0,10);

/*Table structure for table `yyshop_store_cost` */

DROP TABLE IF EXISTS `yyshop_store_cost`;

CREATE TABLE `yyshop_store_cost` (
...
/*Data for the table `yyshop_store_cost` */

/*Table structure for table `yyshop_store_decoration` */

DROP TABLE IF EXISTS `yyshop_store_decoration`;

CREATE TABLE `yyshop_store_decoration` (
...
/*Data for the table `yyshop_store_decoration` */

/*Table structure for table `yyshop_store_decoration_album` */

DROP TABLE IF EXISTS `yyshop_store_decoration_album`;

CREATE TABLE `yyshop_store_decoration_album` (
  `image_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片编号',
...
/*Data for the table `yyshop_store_decoration_album` */

/*Table structure for table `yyshop_store_decoration_block` */

DROP TABLE IF EXISTS `yyshop_store_decoration_block`;

CREATE TABLE `yyshop_store_decoration_block` (
...
/*Data for the table `yyshop_store_decoration_block` */

/*Table structure for table `yyshop_store_distribution` */

DROP TABLE IF EXISTS `yyshop_store_distribution`;

CREATE TABLE `yyshop_store_distribution` (
...
/*Data for the table `yyshop_store_distribution` */

/*Table structure for table `yyshop_store_extend` */

DROP TABLE IF EXISTS `yyshop_store_extend`;

CREATE TABLE `yyshop_store_extend` (
...
/*Data for the table `yyshop_store_extend` */

insert  into `yyshop_store_extend`(`store_id`,`express`,`pricerange`,`orderpricerange`,`bill_cycle`) values (1,NULL,NULL,NULL,0);

/*Table structure for table `yyshop_store_goods_class` */

DROP TABLE IF EXISTS `yyshop_store_goods_class`;

CREATE TABLE `yyshop_store_goods_class` (
...
/*Data for the table `yyshop_store_goods_class` */

/*Table structure for table `yyshop_store_grade` */

DROP TABLE IF EXISTS `yyshop_store_grade`;

CREATE TABLE `yyshop_store_grade` (
...
/*Data for the table `yyshop_store_grade` */

insert  into `yyshop_store_grade`(`sg_id`,`sg_name`,`sg_goods_limit`,`sg_album_limit`,`sg_space_limit`,`sg_template_number`,`sg_template`,`sg_price`,`sg_description`,`sg_function`,`sg_sort`) values (1,'系统默认',100,500,100,6,'default|style1|style2|style3|style4|style5','100.00','用户选择“默认等级”，可以立即开通。','',0),(2,'白金店铺',200,1000,100,6,'default|style1|style2|style3|style4|style5','200.00','享受更多特权','editor_multimedia',2),(3,'钻石店铺',0,1000,100,6,'default|style1|style2|style3|style4|style5','1000.00','','editor_multimedia',100);

/*Table structure for table `yyshop_store_joinin` */

DROP TABLE IF EXISTS `yyshop_store_joinin`;

CREATE TABLE `yyshop_store_joinin` (
  `member_id` int(10) unsigned NOT NULL COMMENT '用户编号',
...
/*Data for the table `yyshop_store_joinin` */

/*Table structure for table `yyshop_store_map` */

DROP TABLE IF EXISTS `yyshop_store_map`;

CREATE TABLE `yyshop_store_map` (
...
/*Data for the table `yyshop_store_map` */

/*Table structure for table `yyshop_store_msg` */

DROP TABLE IF EXISTS `yyshop_store_msg`;

CREATE TABLE `yyshop_store_msg` (
...
/*Data for the table `yyshop_store_msg` */

/*Table structure for table `yyshop_store_msg_read` */

DROP TABLE IF EXISTS `yyshop_store_msg_read`;

CREATE TABLE `yyshop_store_msg_read` (
...
/*Data for the table `yyshop_store_msg_read` */

/*Table structure for table `yyshop_store_msg_setting` */

DROP TABLE IF EXISTS `yyshop_store_msg_setting`;

CREATE TABLE `yyshop_store_msg_setting` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
  `store_id` int(10) unsigned NOT NULL COMMENT '店铺id',
...
/*Data for the table `yyshop_store_msg_setting` */

/*Table structure for table `yyshop_store_msg_tpl` */

DROP TABLE IF EXISTS `yyshop_store_msg_tpl`;

CREATE TABLE `yyshop_store_msg_tpl` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
...
/*Data for the table `yyshop_store_navigation` */

/*Table structure for table `yyshop_store_plate` */

DROP TABLE IF EXISTS `yyshop_store_plate`;

CREATE TABLE `yyshop_store_plate` (
...
/*Data for the table `yyshop_store_plate` */

/*Table structure for table `yyshop_store_reopen` */

DROP TABLE IF EXISTS `yyshop_store_reopen`;

CREATE TABLE `yyshop_store_reopen` (
...
/*Data for the table `yyshop_store_reopen` */

/*Table structure for table `yyshop_store_sns_comment` */

DROP TABLE IF EXISTS `yyshop_store_sns_comment`;

CREATE TABLE `yyshop_store_sns_comment` (
...
/*Data for the table `yyshop_store_sns_comment` */

/*Table structure for table `yyshop_store_sns_setting` */

DROP TABLE IF EXISTS `yyshop_store_sns_setting`;

CREATE TABLE `yyshop_store_sns_setting` (
...
/*Data for the table `yyshop_store_sns_setting` */

/*Table structure for table `yyshop_store_sns_tracelog` */

DROP TABLE IF EXISTS `yyshop_store_sns_tracelog`;

CREATE TABLE `yyshop_store_sns_tracelog` (
...
/*Data for the table `yyshop_store_sns_tracelog` */

/*Table structure for table `yyshop_store_supplier` */

DROP TABLE IF EXISTS `yyshop_store_supplier`;

CREATE TABLE `yyshop_store_supplier` (
...
/*Data for the table `yyshop_store_supplier` */

/*Table structure for table `yyshop_store_watermark` */

DROP TABLE IF EXISTS `yyshop_store_watermark`;

CREATE TABLE `yyshop_store_watermark` (
...
/*Data for the table `yyshop_store_watermark` */

/*Table structure for table `yyshop_store_waybill` */

DROP TABLE IF EXISTS `yyshop_store_waybill`;

CREATE TABLE `yyshop_store_waybill` (
...
/*Data for the table `yyshop_store_waybill` */

/*Table structure for table `yyshop_task` */

DROP TABLE IF EXISTS `yyshop_task`;

CREATE TABLE `yyshop_task` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `yyshop_task` */

insert  into `yyshop_task`(`id`,`taskname`,`dourl`,`islock`,`runtype`,`runtime`,`starttime`,`endtime`,`freq`,`lastrun`,`description`,`parameter`,`settime`,`sta`) values (1,'分','cj_index.php',0,0,'0:10:0',1434038400,1751212800,1,1463809461,'分，建议10分钟触发，更新首页、消息、 邮箱，商品上架，下架，过期等','act=minutes',1433902608,'运行'),(2,'时','cj_index.php',0,0,'0:20:0',1433865600,1751212800,60,1463809494,'时，建议1小时触发，更新商品全文搜索缓存等','act=hour',1433902608,'运行'),(3,'天','cj_index.php',0,0,'0:30:0',1433865600,1756569600,1440,1463809495,'天，建议每天触发，更新更新订单、佣金、结算等','act=date',1433902608,'运行');

/*Table structure for table `yyshop_transport` */

DROP TABLE IF EXISTS `yyshop_transport`;

CREATE TABLE `yyshop_transport` (
...
/*Data for the table `yyshop_transport` */

/*Table structure for table `yyshop_transport_extend` */

DROP TABLE IF EXISTS `yyshop_transport_extend`;

CREATE TABLE `yyshop_transport_extend` (
...
/*Data for the table `yyshop_transport_extend` */

/*Table structure for table `yyshop_type` */

DROP TABLE IF EXISTS `yyshop_type`;

CREATE TABLE `yyshop_type` (
  `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '类型id',
...
/*Data for the table `yyshop_type` */

/*Table structure for table `yyshop_type_brand` */

DROP TABLE IF EXISTS `yyshop_type_brand`;

CREATE TABLE `yyshop_type_brand` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `brand_id` int(10) unsigned NOT NULL COMMENT '品牌id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与品牌对应表';

/*Data for the table `yyshop_type_brand` */

/*Table structure for table `yyshop_type_custom` */

DROP TABLE IF EXISTS `yyshop_type_custom`;

CREATE TABLE `yyshop_type_custom` (
...
/*Data for the table `yyshop_type_custom` */

/*Table structure for table `yyshop_type_spec` */

DROP TABLE IF EXISTS `yyshop_type_spec`;

CREATE TABLE `yyshop_type_spec` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `sp_id` int(10) unsigned NOT NULL COMMENT '规格id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与规格对应表';

/*Data for the table `yyshop_type_spec` */

/*Table structure for table `yyshop_upload` */

DROP TABLE IF EXISTS `yyshop_upload`;

CREATE TABLE `yyshop_upload` (
...
/*Data for the table `yyshop_upload` */

insert  into `yyshop_upload`(`upload_id`,`file_name`,`file_thumb`,`file_size`,`upload_type`,`upload_time`,`item_id`) values (175,'help_store_04526250471329237.jpg',NULL,93814,2,1496590271,97),(176,'help_store_04526250486031950.jpg',NULL,402109,2,1496590271,97),(177,'help_store_04526250504192250.jpg',NULL,248466,2,1496590271,97),(180,'help_store_04526254603037325.jpg',NULL,884442,2,1496590271,99);

/*Table structure for table `yyshop_voucher` */

DROP TABLE IF EXISTS `yyshop_voucher`;

CREATE TABLE `yyshop_voucher` (
...
/*Data for the table `yyshop_voucher` */

/*Table structure for table `yyshop_voucher_price` */

DROP TABLE IF EXISTS `yyshop_voucher_price`;

CREATE TABLE `yyshop_voucher_price` (
...
/*Data for the table `yyshop_voucher_price` */

/*Table structure for table `yyshop_voucher_quota` */

DROP TABLE IF EXISTS `yyshop_voucher_quota`;

CREATE TABLE `yyshop_voucher_quota` (
...
/*Data for the table `yyshop_voucher_quota` */

/*Table structure for table `yyshop_voucher_template` */

DROP TABLE IF EXISTS `yyshop_voucher_template`;

CREATE TABLE `yyshop_voucher_template` (
...
/*Data for the table `yyshop_voucher_template` */

/*Table structure for table `yyshop_vr_groupbuy_area` */

DROP TABLE IF EXISTS `yyshop_vr_groupbuy_area`;

CREATE TABLE `yyshop_vr_groupbuy_area` (
...
/*Data for the table `yyshop_vr_order` */

/*Table structure for table `yyshop_vr_order_bill` */

DROP TABLE IF EXISTS `yyshop_vr_order_bill`;

CREATE TABLE `yyshop_vr_order_bill` (
...
/*Data for the table `yyshop_vr_order_bill` */

/*Table structure for table `yyshop_vr_order_code` */

DROP TABLE IF EXISTS `yyshop_vr_order_code`;

CREATE TABLE `yyshop_vr_order_code` (
...
/*Data for the table `yyshop_vr_order_code` */

/*Table structure for table `yyshop_vr_order_snapshot` */

DROP TABLE IF EXISTS `yyshop_vr_order_snapshot`;

CREATE TABLE `yyshop_vr_order_snapshot` (
...
/*Data for the table `yyshop_vr_order_snapshot` */

/*Table structure for table `yyshop_vr_order_statis` */

DROP TABLE IF EXISTS `yyshop_vr_order_statis`;

CREATE TABLE `yyshop_vr_order_statis` (
  `os_month` mediumint(9) unsigned NOT NULL DEFAULT '0' COMMENT '统计编号(年月)',
  `os_year` smallint(6) DEFAULT '0' COMMENT '年',
  `os_start_date` int(11) NOT NULL COMMENT '开始日期',
  `os_end_date` int(11) NOT NULL COMMENT '结束日期',
...
/*Data for the table `yyshop_vr_order_statis` */

/*Table structure for table `yyshop_vr_refund` */

DROP TABLE IF EXISTS `yyshop_vr_refund`;

CREATE TABLE `yyshop_vr_refund` (
  `refund_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
/*Data for the table `yyshop_vr_refund` */

/*Table structure for table `yyshop_vr_refund_detail` */

DROP TABLE IF EXISTS `yyshop_vr_refund_detail`;

CREATE TABLE `yyshop_vr_refund_detail` (
  `refund_id` int(10) unsigned NOT NULL COMMENT '记录ID',
  `order_id` int(10) unsigned NOT NULL COMMENT '订单ID',
  `batch_no` varchar(32) NOT NULL COMMENT '批次号',
  `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额',
...
/*Data for the table `yyshop_vr_refund_detail` */

/*Table structure for table `yyshop_waybill` */

DROP TABLE IF EXISTS `yyshop_waybill`;

CREATE TABLE `yyshop_waybill` (
...
/*Data for the table `yyshop_web` */

insert  into `yyshop_web`(`web_id`,`web_name`,`style_name`,`web_page`,`update_time`,`web_sort`,`web_show`,`web_html`) values (1,'红色','red','index',1496590271,1,1,''),(2,'粉色','pink','index',1496590271,1,1,''),(3,'橘色','orange','index',1496590271,2,1,''),(4,'绿色','green','index',1496590271,3,1,''),(5,'蓝色','blue','index',1496590271,4,1,''),(6,'紫色','purple','index',1496590271,6,1,''),(7,'褐色','brown','index',1496590271,7,1,''),(8,'默认','default','index',1496590271,8,1,''),(101,'首页头部焦点图片','orange','index_pic',1419819162,100,1,''),(121,'首页促销区','orange','index_sale',1419819162,120,1,'');

/*Table structure for table `yyshop_web_channel` */

DROP TABLE IF EXISTS `yyshop_web_channel`;

CREATE TABLE `yyshop_web_channel` (
...
/*Data for the table `yyshop_web_channel` */

/*Table structure for table `yyshop_web_code` */

DROP TABLE IF EXISTS `yyshop_web_code`;

CREATE TABLE `yyshop_web_code` (
