...
<script type="text/ecmascript-6">
  export default {
    ...
    created() {
      ...
      this.initRadius = 36 * this.ratio
      this.minHeadRadius = 24 * this.ratio
      this.minTailRadius = 10 * this.ratio
      this.initArrowRadius = 20 * this.ratio
      this.minArrowRadius = 12 * this.ratio
      this.arrowWidth = 6 * this.ratio
      this.maxDistance = 80 * this.ratio
      this.initCenterX = 50 * this.ratio
      this.initCenterY = 50 * this.ratio
      this.headCenter = {
        x: this.initCenterX,
        y: this.initCenterY
      }
