        ...
        return (
            <Layout  className="serve news container" title="法币交易区买入规则">
                  <article className="container article">
                    ...
                    <p className="opacity-5">8、为了保证交易的及时性，请选择实时到账的汇款方式，例如支付宝、飞马钱包、银行实时汇款等。节假日或工作日的17：00-9：00，超过5万以上的汇款请分批支付，以确保到款的及时性。买家点击“我已付款”两个小时后，卖家未收到付款，订单出现申诉时，卖家可以拒绝成交。</p>
