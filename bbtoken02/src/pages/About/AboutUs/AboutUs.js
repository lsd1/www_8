            ...
            <Layout  className="about aboutUs" title={intl.get('FOOT_COMY')}>
              <img className="about-img" src={require('@/assets/images/about.jpg')} alt="" />
                 <article className="container article">
                    <h3 className="headline lin-1 mb-lg">关于 EXBB</h3>
                    <p className="opacity-5">EXBB.全球领先的区块链资产交易 平台。聚合全球优质区块链资产，为全球用户提供优质 的区块链项目投资机会，以及更加安全、便捷的区块链 资产兑换服务。拥有最专业的区块链技术应用开发团队， 平台采用GSLB、分布式服务器集群、分布式存储、多机 互备的高速内存交易引擎、冷钱包、私钥离线化的热钱 包等先进的技术，建立世界顶级的安全风控体系，打造 金融级别的专业区块链资产交易平台；同时，我们以PC 端、手机端等多终端为客户提供安全、稳定、便捷的数 字资产交易服务，并会根据客户的建议和需求，不断改 进和升级产品和服务。</p>
                    ...
                    <p className="opacity-5">5 https://www.EXBB.io为本网站唯一官方对外信息公布平台；</p>
