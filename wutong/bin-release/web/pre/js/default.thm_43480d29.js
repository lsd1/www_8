                ...
                generateEUI.skins = {};generateEUI.paths['resource/garden_skin/auction/AuctionBanner.exml'] = window.auctionBanner = (function (_super) {
	...
	function goldCoin() {
		_super.call(this);
		this.skinParts = ["head_img","goBack","exchange_top","svc_inp","add","del","gold_inp","change_ratio","confirm","exchange"];
		...
		eui.Binding.$bindProperties(this, ["hostComponent.data.goldCoin.input_svc"],[0],this._Label2,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.goldCoin.input_gold"],[0],this._Label3,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.goldCoin.exchange_ratio"],[0],this._Label4,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.goldCoin.exchange_tips"],[0],this._Label5,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.data.goldCoin.confirm"],[0],this._Label7,"text");
	}
	...
	_proto.exchange_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image1_i(),this.exchange_top_i(),this._Label1_i(),this._Label2_i(),this.svc_inp_i(),this.add_i(),this.del_i(),this._Label3_i(),this.gold_inp_i(),this._Label4_i(),this._Label5_i(),this._Rect1_i(),this._Rect2_i(),this.change_ratio_i(),this._Label6_i(),this.confirm_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.confirm_i = function () {
		...
		t.horizontalCenter = 0;
		t.width = 600;
		t.elementsContent = [this._Image4_i(),this._Label7_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
	...
	function scrollerRecordsIncome() {
		_super.call(this);
		this.skinParts = ["go_link","the_link","change_link","exchange","scroller_box","now_income","cumu_income","cumulativeText","scrollerRecordsIncome"];
		...
		eui.Binding.$bindProperties(this, ["hostComponent.langData.scrollerRecordsIncome.changeVSC"],[0],this._Label2,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.langData.scrollerRecordsIncome.exchange_vsc"],[0],this._Label3,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.langData.scrollerRecordsIncome.current"],[0],this._Label4,"text");
	}
	...
	_proto._Group1_i = function () {
		...
		t.left = 0;
		t.right = 0;
		t.elementsContent = [this.go_link_i(),this.change_link_i(),this.exchange_i()];
		return t;
	};
	...
	_proto.change_link_i = function () {
		...
		t.width = 610;
		t.y = 31;
		t.elementsContent = [this._Image2_i(),this._Label2_i(),this.the_link_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.the_link_i = function () {
		var t = new eui.Label();
		this.the_link = t;
		t.fontFamily = "PingFang-SC-Medium";
		t.horizontalCenter = 0.5;
		t.text = "asdfasdfasdfasdfasdfasdf";
		t.textColor = 0xFFE5B8;
		t.verticalCenter = 16;
		return t;
	};
	...
	_proto.cumulativeText_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.now_income_i(),this._Label4_i(),this.cumu_income_i(),this._Rect1_i()];
		return t;
	};
