...
if ($) 
{
	$.extend(
	{
		...
		*/
		...
		select: function(selectId,value,area)
		{
			if(value)
			{
				if(area){
					$('#'+selectId,area).children("[value='"+value+"']").attr("selected", true);
				}else{
			...
			{
				if(area){
					return $('#'+selectId,area).children(":selected");
				}else{
		...
		radio: function(radioNames,value,area)
		{
			if(value)
			{
				if(area){
					$("input:radio[name='"+radioNames+"'][value='"+value+"']",area).attr("checked", true);
				}else{
			...
			{
				if(area){
					return $("input:radio[name='"+radioNames+"']:checked",area);
				}else{
