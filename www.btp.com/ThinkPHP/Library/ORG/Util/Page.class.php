...
class Page {
    ...
    public function __construct($totalRows,$listRows='',$parameter='') {
    	$this->config  =	array('header'=>L('条记录'),'prev'=>L('上一页'),'next'=>L('下一页'),'first'=>L('首页'),'last'=>L('尾页'),'theme'=>L('共有').'%totalRow% %header% %nowPage%/%totalPage% '.L('页').' %first% &nbsp; %upPage% &nbsp;%linkPage% &nbsp;&nbsp; %downPage% &nbsp; %end%');
