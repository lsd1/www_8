...
namespace Vendor\Spout\Reader\Wrapper;
 ...
 *
 * @package Vendor\Spout\Reader\Wrapper
 */
class SimpleXMLElement
{
     ...
     * @throws \Vendor\Spout\Reader\Exception\XMLProcessingException If the XML string is not well-formed
     */
