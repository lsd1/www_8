...
use Vendor\Spout\Reader\Exception\IteratorNotRewindableException;
use Vendor\Spout\Reader\Exception\XMLProcessingException;
use Vendor\Spout\Reader\IteratorInterface;
use Vendor\Spout\Reader\ODS\Helper\CellValueFormatter;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     */
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-row>" starting node
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
