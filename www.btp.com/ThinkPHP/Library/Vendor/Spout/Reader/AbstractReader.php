...
use Vendor\Spout\Reader\Exception\ReaderNotOpenedException;
...
abstract class AbstractReader implements ReaderInterface
{
    ...
    /** @var \Vendor\Spout\Reader\Common\ReaderOptions Reader's customized options */
    protected $options;

    /**
     * Returns the reader's current options
     *
     * @return \Vendor\Spout\Reader\Common\ReaderOptions
     */
     ...
     * @param  string $filePath Path of the file to be read
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If the file at the given path does not exist, is not readable or is corrupted
     */
