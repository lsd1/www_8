...
use Vendor\Spout\Reader\XLSX\Helper\CellHelper;
use Vendor\Spout\Reader\XLSX\Helper\CellValueFormatter;
use Vendor\Spout\Reader\XLSX\Helper\StyleHelper;
use Vendor\Spout\Reader\Common\XMLProcessor;
...
class RowIterator implements IteratorInterface
{
    ...
    /** @var \Vendor\Spout\Reader\Wrapper\XMLReader The XMLReader object that will help read sheet's XML data */
    protected $xmlReader;

    /** @var \Vendor\Spout\Reader\Common\XMLProcessor Helper Object to process XML nodes */
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If the sheet data XML cannot be read
     */
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Reader\Exception\SharedStringNotFoundException If a shared string was not found
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to read the sheet data XML
     */
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<dimension>" starting node
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" node
     * @return int Row index
     * @throws \Vendor\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
     */
    ...
    /**
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<c>" node
