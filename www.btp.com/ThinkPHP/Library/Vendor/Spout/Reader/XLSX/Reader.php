...
use Vendor\Spout\Reader\AbstractReader;
use Vendor\Spout\Reader\XLSX\Helper\SharedStringsHelper;
...
class Reader extends AbstractReader
{
     ...
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If the file at the given path or its content cannot be read
