...
namespace Vendor\Spout\Reader\XLSX\Helper\SharedStringsCaching;

use Vendor\Spout\Common\Helper\FileSystemHelper;
use Vendor\Spout\Common\Helper\GlobalFunctionsHelper;
use Vendor\Spout\Reader\Exception\SharedStringNotFoundException;
 ...
 *
 * @package Vendor\Spout\Reader\XLSX\Helper\SharedStringsCaching
 */
class FileBasedStrategy implements CachingStrategyInterface
{
    ...
    /** @var \Vendor\Spout\Common\Helper\FileSystemHelper Helper to perform file system operations */
