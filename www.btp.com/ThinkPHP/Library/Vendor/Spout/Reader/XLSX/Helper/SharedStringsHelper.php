...
use Vendor\Spout\Reader\Wrapper\SimpleXMLElement;
use Vendor\Spout\Reader\Wrapper\XMLReader;
use Vendor\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyFactory;
use Vendor\Spout\Reader\XLSX\Helper\SharedStringsCaching\CachingStrategyInterface;
...
class SharedStringsHelper
{
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If sharedStrings.xml can't be read
     */
     ...
     *
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @return int|null Number of unique shared strings in the sharedStrings.xml file
     * @throws \Vendor\Spout\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     */
     ...
     *
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader
     * @param int $sharedStringIndex Index of the processed shared strings item
     * @param \Vendor\Spout\Common\Escaper\XLSX $escaper Helper to escape values
     * @return void
     */
     ...
     *
     * @param \Vendor\Spout\Reader\Wrapper\XMLReader $xmlReader
     * @return \Vendor\Spout\Reader\Wrapper\SimpleXMLElement
     * @throws \Vendor\Spout\Common\Exception\IOException If the current node cannot be read
     */
     ...
     *
     * @param \Vendor\Spout\Reader\Wrapper\SimpleXMLElement $parentNode Parent node that may contain nodes to remove
     * @return \Vendor\Spout\Reader\Wrapper\SimpleXMLElement Cleaned parent node
     */
     ...
     *
     * @param \Vendor\Spout\Reader\Wrapper\SimpleXMLElement $textNode The text node element (<t>) whitespace may be preserved
     ...
     * @throws \Vendor\Spout\Reader\Exception\SharedStringNotFoundException If no shared string found for the given index
     */
