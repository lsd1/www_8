...
namespace Vendor\Spout\Writer\CSV;

use Vendor\Spout\Writer\AbstractWriter;
use Vendor\Spout\Common\Exception\IOException;
use Vendor\Spout\Common\Helper\EncodingHelper;

/**
 * Class Writer
 * This class provides support to write data to CSV files
 *
 * @package Vendor\Spout\Writer\CSV
 */
class Writer extends AbstractWriter
{
     ...
     * @param \Vendor\Spout\Writer\Style\Style $style Ignored here since CSV does not support styling.
     * @return void
