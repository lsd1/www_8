...
namespace Vendor\Spout\Writer;

use Vendor\Spout\Common\Exception\IOException;
use Vendor\Spout\Common\Exception\InvalidArgumentException;
use Vendor\Spout\Common\Exception\SpoutException;
use Vendor\Spout\Common\Helper\FileSystemHelper;
use Vendor\Spout\Writer\Exception\WriterAlreadyOpenedException;
use Vendor\Spout\Writer\Exception\WriterNotOpenedException;
use Vendor\Spout\Writer\Style\StyleBuilder;

/**
 * Class AbstractWriter
 *
 * @package Vendor\Spout\Writer
 * @abstract
 */
abstract class AbstractWriter implements WriterInterface
{
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If the writer cannot be opened
     */
     ...
     * @return AbstractWriter
     * @throws \Vendor\Spout\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     */
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If the pointer is not available
     */
     ...
     * @return void
     * @throws \Vendor\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened and must not be.
     */
     ...
     * @api
     * @return AbstractWriter
     * @throws \Vendor\Spout\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to write data
     * @throws \Vendor\Spout\Common\Exception\SpoutException If anything else goes wrong while writing data
     */
     ...
     * @return AbstractWriter
     * @throws \Vendor\Spout\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \Vendor\Spout\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to write data
     */
