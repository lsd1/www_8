...
namespace Vendor\Spout\Writer\ODS\Internal;
 ...
 *
 * @package Vendor\Spout\Writer\ODS\Internal
 */
class Worksheet implements WorksheetInterface
{
    ...
    /** @var \Vendor\Spout\Common\Escaper\ODS Strings escaper */
    protected $stringsEscaper;

    /** @var \Vendor\Spout\Common\Helper\StringHelper To help with string manipulation */
    ...
    public function __construct($externalSheet, $worksheetFilesFolder)
    {
        ...
        $this->stringsEscaper = \Vendor\Spout\Common\Escaper\ODS::getInstance();
