...
use Vendor\Spout\Writer\Common\Helper\AbstractStyleHelper;
use Vendor\Spout\Writer\Style\Color;
use Vendor\Spout\Writer\Style\Style;
...
EOD;
    ...
    protected function getFontsSectionContent()
    {
        ...
        /** @var \Vendor\Spout\Writer\Style\Style $style */
        ...
        foreach ($this->registeredBorders as $styleId) {
            ...
            foreach ($sortOrder as $partName) {
                if ($border->hasPart($partName)) {
                    /** @var $part \Vendor\Spout\Writer\Style\BorderPart */
