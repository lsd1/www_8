...
namespace Vendor\Spout\Writer\XLSX\Helper;

use Vendor\Spout\Writer\Common\Helper\ZipHelper;
use Vendor\Spout\Writer\XLSX\Internal\Worksheet;
 ...
 *
 * @package Vendor\Spout\Writer\XLSX\Helper
 */
class FileSystemHelper extends \Vendor\Spout\Common\Helper\FileSystemHelper
{
     ...
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to create the folder
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to create the folder or the ".rels" file
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to create the file
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to create the folder or one of the files
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to create at least one of the folders
     */
