...
namespace Vendor\Spout\Writer\XLSX\Internal;

use Vendor\Spout\Common\Exception\InvalidArgumentException;
use Vendor\Spout\Common\Exception\IOException;
use Vendor\Spout\Common\Helper\StringHelper;
use Vendor\Spout\Writer\Common\Helper\CellHelper;
use Vendor\Spout\Writer\Common\Internal\WorksheetInterface;
 ...
 *
 * @package Vendor\Spout\Writer\XLSX\Internal
 */
...
EOD;
    ...
    /** @var \Vendor\Spout\Writer\Common\Sheet The "external" sheet */
    protected $externalSheet;

    /** @var string Path to the XML file that will contain the sheet data */
    protected $worksheetFilePath;

    /** @var \Vendor\Spout\Writer\XLSX\Helper\SharedStringsHelper Helper to write shared strings */
    protected $sharedStringsHelper;

    /** @var \Vendor\Spout\Writer\XLSX\Helper\StyleHelper Helper to work with styles */
    protected $styleHelper;

    /** @var bool Whether inline or shared strings should be used */
    protected $shouldUseInlineStrings;

    /** @var \Vendor\Spout\Common\Escaper\XLSX Strings escaper */
    protected $stringsEscaper;

    /** @var \Vendor\Spout\Common\Helper\StringHelper String helper */
    ...
    /**
     * @param \Vendor\Spout\Writer\Common\Sheet $externalSheet The associated "external" sheet
     * @param string $worksheetFilesFolder Temporary folder where the files to create the XLSX will be stored
     * @param \Vendor\Spout\Writer\XLSX\Helper\SharedStringsHelper $sharedStringsHelper Helper for shared strings
     * @param \Vendor\Spout\Writer\XLSX\Helper\StyleHelper Helper to work with styles
     * @param bool $shouldUseInlineStrings Whether inline or shared strings should be used
     * @throws \Vendor\Spout\Common\Exception\IOException If the sheet data file cannot be opened for writing
     */
    public function __construct($externalSheet, $worksheetFilesFolder, $sharedStringsHelper, $styleHelper, $shouldUseInlineStrings)
    {
        ...
        $this->stringsEscaper = \Vendor\Spout\Common\Escaper\XLSX::getInstance();
    ...
    /**
     * @return \Vendor\Spout\Writer\Common\Sheet The "external" sheet
     */
     ...
     * @param \Vendor\Spout\Writer\Style\Style $style Style to be applied to the row. NULL means use default style.
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If the data cannot be written
     * @throws \Vendor\Spout\Common\Exception\InvalidArgumentException If a cell value's type is not supported
     */
