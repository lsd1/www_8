...
namespace Vendor\Spout\Writer\XLSX;

use Vendor\Spout\Writer\AbstractMultiSheetsWriter;
use Vendor\Spout\Writer\Style\StyleBuilder;
use Vendor\Spout\Writer\XLSX\Internal\Workbook;

/**
 * Class Writer
 * This class provides base support to write data to XLSX files
 *
 * @package Vendor\Spout\Writer\XLSX
 */
class Writer extends AbstractMultiSheetsWriter
{
     ...
     * @return Writer
     * @throws \Vendor\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened
     */
     ...
     *
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to open the file for writing
     */
     ...
     * @return void
     * @throws \Vendor\Spout\Writer\Exception\WriterNotOpenedException If the book is not created yet
