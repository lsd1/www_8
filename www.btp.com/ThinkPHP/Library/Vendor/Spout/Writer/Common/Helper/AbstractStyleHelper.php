...
namespace Vendor\Spout\Writer\Common\Helper;

/**
 * Class AbstractStyleHelper
 * This class provides helper functions to manage styles
 *
 * @package Vendor\Spout\Writer\Common\Helper
 */
abstract class AbstractStyleHelper
{
    ...
    /**
     * @param \Vendor\Spout\Writer\Style\Style $defaultStyle
     */
     ...
     *
     * @param \Vendor\Spout\Writer\Style\Style $style The style to be registered
     * @return \Vendor\Spout\Writer\Style\Style The registered style, updated with an internal ID.
     */
     ...
     *
     * @param \Vendor\Spout\Writer\Style\Style $style
     * @return bool
     */
     ...
     * @return \Vendor\Spout\Writer\Style\Style
     */
    ...
    /**
     * @return \Vendor\Spout\Writer\Style\Style[] List of registered styles
     */
     ...
     *
     * @return \Vendor\Spout\Writer\Style\Style Default style
     */
     ...
     *
     * @param \Vendor\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \Vendor\Spout\Writer\Style\Style The updated style
     */
     ...
     * @param \Vendor\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \Vendor\Spout\Writer\Style\Style The eventually updated style
     */
