...
namespace Vendor\Spout\Writer\Common;

use Vendor\Spout\Common\Helper\StringHelper;
use Vendor\Spout\Writer\Exception\InvalidSheetNameException;
...
class Sheet
{
    ...
    /** @var \Vendor\Spout\Common\Helper\StringHelper */
     ...
     * @return Sheet
     * @throws \Vendor\Spout\Writer\Exception\InvalidSheetNameException If the sheet's name is invalid.
     */
