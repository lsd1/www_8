...
namespace Vendor\Spout\Writer\Common\Internal;

use Vendor\Spout\Writer\Exception\SheetNotFoundException;
 ...
 *
 * @package Vendor\Spout\Writer\Common
 */
abstract class AbstractWorkbook implements WorkbookInterface
{
     ...
     * @param \Vendor\Spout\Writer\Style\Style $defaultRowStyle
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to create at least one of the base folders
     */
    ...
    /**
     * @return \Vendor\Spout\Writer\Common\Helper\AbstractStyleHelper The specific style helper
     */
     ...
     * @throws \Vendor\Spout\Common\Exception\IOException If unable to open the sheet for writing
     */
     ...
     * The writing will resume where it stopped (i.e. data won't be truncated).
     *
     * @param \Vendor\Spout\Writer\Common\Sheet $sheet The "external" sheet to set as current
     * @return void
     * @throws \Vendor\Spout\Writer\Exception\SheetNotFoundException If the given sheet does not exist in the workbook
     */
     ...
     *
     * @param \Vendor\Spout\Writer\Common\Sheet $sheet
     ...
     * @param \Vendor\Spout\Writer\Style\Style $style Style to be applied to the row.
     * @return void
     * @throws \Vendor\Spout\Common\Exception\IOException If trying to create a new sheet and unable to open the sheet for writing
     * @throws \Vendor\Spout\Writer\Exception\WriterException If unable to write data
     */
