...
use Vendor\Spout\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
     ...
     * @throws \Vendor\Spout\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
     */
