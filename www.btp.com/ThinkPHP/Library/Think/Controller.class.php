...
abstract class Controller {
   ...
   /**
    ...
    protected function ajaxReturn($data=[],$type='',$json_option=0) {
        /**参数1 注释
         * 第一个参数传入数组 例：array('data'=>array(),'info'=>'成功','status'=>1) 
         * data单元为数据单元 取值字符串或者数组 
         * status 缺省值1
         * info 缺省值""
         * 也可以追加其他单元放过数据 如果前台使用for in时使用独立的data单元更简便
         */
        ...
        $data['navTabId']  =  I('request.navTabId');
        $data['navTabTitle']  =  I('request.navTabTitle');
        $data['rel']  =  I('request.rel');
        $data['callbackType']  =  I('request.callbackType');
        $data['forwardUrl']  =  I('request.forwardUrl');
        $data['confirmMsg']  =  I('request.confirmMsg');
