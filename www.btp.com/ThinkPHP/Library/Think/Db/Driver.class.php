...
abstract class Driver {
    ...
    protected $options = array(
        PDO::ATTR_CASE              =>  PDO::CASE_NATURAL,//PDO::CASE_LOWER,//
    ...
    public function connect($config='',$linkNum=0,$autoConnection=false) {
        if ( !isset($this->linkID[$linkNum]) ) {
            ...
            try{
                ...
                $this->linkID[$linkNum]->exec("SET sql_mode='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION'"); // 开启严格模式
